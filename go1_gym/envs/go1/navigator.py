...
class Navigator(VelocityTrackingEasyEnv):
    def __init__(self, sim_device, headless, num_envs=None, prone=False, deploy=False,
                    cfg: Cfg = None, eval_cfg: Cfg = None, initial_dynamics_dict=None, physics_engine="SIM_PHYSX", locomtion_model_dir = "/common/home/hk919/walk-these-ways/runs/gait-conditioned-agility/pretrain-v0/train/025417.456545", behavior_commands = {
                        "body_height" : 0.0,
                        "step_frequency" : 3.0,
