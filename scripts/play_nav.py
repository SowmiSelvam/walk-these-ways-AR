...
def load_policy(logdir):
    body = torch.jit.load(logdir + '/checkpoints/body_latest.jit')
    import os
    adaptation_module = torch.jit.load('/common/home/hk919/walk-these-ways/scripts/tmp/legged_data/adaptation_module_latest.jit')
...
def play_go1(headless=False):
    ...
    label_nav = "/common/home/hk919/walk-these-ways/hk919/scratch/2023/12-06/215436"

    label = "/common/home/hk919/walk-these-ways/runs/gait-conditioned-agility/pretrain-v0/train/025417.456545"
